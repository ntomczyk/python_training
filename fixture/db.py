    ...
    def get_contact_list(self):
        ...
        try:
            ...
            for row in cursor:
                ...
                list.append(Contact(id=str(id), firstname=firstname, lastname=lastname, nickname=nickname, home_number=home, mobile_number=mobile, work_number=work, email=email, email2=email2))
        finally:
            cursor.close()
        return list
